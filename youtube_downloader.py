...
pafy.set_api_key('AIzaSyD3gmH7hg4a4SbK7b0uWuwqWkahBMYaFuA')

playlist_url = 'https://www.youtube.com/playlist?list=PLNq88bu4upmtvV76pGpbLqPnOk5_iinL7'
webm_dir = 'downloads'
mp3_dir = 'mp3s'
keepcharacters = (' ', '.', '_', '-')
verbose = False
...
print('[*] Playlist "%s" has %d videos!' % (playlist.title, len(playlist)))
